	...
	public static void main(String [] args) {
      ...
      //
			 ...
			 */
    			...
    			DES.encrypt(new FileInputStream("double.txt"), new FileOutputStream("doubleDes"));
					//for part 2
					//DES.encrypt(new FileInputStream("doubleDes"), new FileOutputStream("doubleDes2"));
    			DES.decrypt(new FileInputStream("doubleDes2"), new FileOutputStream("dedoubleDes"));
					// for part 2
					//DES.decrypt(new FileInputStream("dedoubleDes"), new FileOutputStream("dedoubleDes.txt"));

    			// DesEncrypter TDES = new DesEncrypter("test passphrase", "PBEWithMD5AndTripleDES" );
    			// TDES.encrypt(new FileInputStream("b.png"), new FileOutputStream("TDESbpng"));
    			// TDES.decrypt(new FileInputStream("DESCIPHERTEXT"), new FileOutputStream("DESWith3DES.txt"));
		}
